...
<html>
              ...
              <div class="ConBox">
	            <div class="hd">
	             <table border="0" cellpadding="0"  align="center" cellspacing="0" height="30px">
  					<tr>
   <td width="64px"><a href="index.jsp"><img name="topmenu_r1" src="image/topmenu_r1_c1.gif"  width="65px" height="29px" border="0" id="topmenu_r1_c1" alt="" /></a></td>
   <td style="position:relative;width:65px"><a href="ti2ch.jsp"><img name="topmenu_r2" src="image/topmenu_r1_c2.gif"  width="65px" height="29px"  border="0" id="topmenu_r1_c2" alt="" /></a></td>
  <td style="position:relative;width:65px" ><a href="indexora.jsp"><img name="topmenu_r2" src="image/topmenu_r1_c3.gif"  width="65px" height="29px" border="0" id="topmenu_r1_c2" alt="" /></a></td>
   <td style="position:relative;width:80px" ><a href="ti2chOra.jsp"><img name="topmenu_r2" src="image/curmenu_r1_c4.gif"  style="position:absolute;z-index:100px" width="80px" height="32px" border="0" id="topmenu_r1_c2" alt="" /></a></td>
  	<td style="position:relative;width:65px" ><a href="indexch2vi.jsp"><img name="topmenu_r2" src="image/topmenu_r1_c5.gif"  width="65px" height="29px" border="0" id="topmenu_r1_c2" alt="" /></a></td>
...
<!-- 
					...
					<form action="transti2chOra!ti2chOra" method="post" id="transti2chOra" name="transForm">
                                                <div class="row desc"><span style="font-family:宋体">源语言：</span>
											<input type="button" value="清除" onclick="clearCh()"/>
                                                </div>
                                                <div class="row border content">
                                                        <textarea id="inputText" class="text" style="height:587px" dir="ltr" tabindex="1" wrap="SOFT" name="inputText"  >${inputText}	</textarea>
							...
							<input type="button"  onclick="submitTi2chOra()" value="点击翻译"/>
                              </div>
                                    </form>    
                                 </div>
            <!-- end of wrapper -->
