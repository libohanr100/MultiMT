...
<html>
  ...
  <td style="position:relative;width:65px" ><a href="indexora.jsp"><img name="topmenu_r2" src="image/topmenu_r1_c3.gif"  width="65px" height="29px" border="0" id="topmenu_r1_c2" alt="" /></a></td>
   ...
   <td style="position:relative;" ><a href="vi2ch.jsp"><img name="topmenu_r2" src="image/curmenu_r1_c6.gif"  style="position:absolute;z-index:100px" width="80px" height="32px" border="0" id="topmenu_r1_c2" alt="" /></a></td>
...
<!-- 
					...
					<form action="transvi2ch!vi2ch" method="post" id="transti2ch" name="transForm">
							...
							<input type="button"  onclick="submitTi2ch()" value="点击翻译"/>
                              </div>
                                    </form>    
                                 </div>
            <!-- end of wrapper -->
