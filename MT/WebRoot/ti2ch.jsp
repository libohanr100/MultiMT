...
<html>
  ...
  <%
   ...
   <td style="position:relative;width:80px"><img name="topmenu_r2" src="image/curmenu_r1_c2.gif"  width="80px" height="32px" style="position:absolute;z-index:100px" border="0" id="topmenu_r1_c2" alt="" /></td>
...
<!-- 
					...
					<form action="transti2ch!ti2ch" method="post" id="transti2ch" name="transForm">
