...
<html>
  ...
  <td style="position:relative;width:80px" ><a href="indexora.jsp"><img name="topmenu_r2" style="position:absolute;z-index:100px" src="image/curmenu_r1_c3.gif"  width="80px" height="32px" border="0" id="topmenu_r1_c2" alt="" /></a></td>
...
<!-- 
					...
					<form action="transch2tiOra!ch2tiOra" method="post" id="transch2tiOra" name="transForm">
							...
							<input type="button"  onclick="submitCh2tiOra()" value="点击翻译"/>
                              </div>
                                    </form>    
                                 </div>
            <!-- end of wrapper -->
