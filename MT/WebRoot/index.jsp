...
<html>
  ...
  <%
   ...
   <tr>
   <td style="position:relative;align:left" width="80px" ><img name="topmenu_r1" style="position:absolute;z-index:100px" src="image/curmenu_r1_c1.gif"  width="80px" height="32px" border="0" id="topmenu_r1_c1" alt="" /></td>
...
<!-- 
					...
					<form action="transch2ti" method="post" id="transch2ti" name="transForm">
